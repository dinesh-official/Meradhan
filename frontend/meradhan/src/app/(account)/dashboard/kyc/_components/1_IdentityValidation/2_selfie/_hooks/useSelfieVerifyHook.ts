...
export const useSelfieVerifyHook = () => {
    ...
    const verifySelfieInfoMutation = useMutation({
        ...
        mutationFn: async (kid: string) => await kycApi.verifySelfieVerification({ kid }),
        onSuccess: (data) => {
    ...
    const requestSelfieMutation = useMutation({
        ...
        mutationFn: async () => await kycApi.requestSelfieVerification({
    ...
    return {
        ...
        isPending: requestSelfieMutation.isPending || verifySelfieInfoMutation.isPending
    }
