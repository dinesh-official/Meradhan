...
query BondCategories($filters: BondCategoryFiltersInput, $pagination: PaginationArg) {
...
export const generateBondCategoryMetaData = async (name: string): Promise<Metadata> => {
