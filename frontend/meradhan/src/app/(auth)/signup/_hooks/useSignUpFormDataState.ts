...
export const useSignUpFormDataState = () => {
    ...
    const [signUpFormError, setSignUpFormError] = useState<Record<keyof SignUPFormSchemaType, string>>({
        firstName: "",
        lastName: "",
        email: "",
        mobile: "",
    ...
    const handleSignUpFormChange = (key: keyof SignUPFormSchemaType, value: string | boolean | number) => {
