...
function SignUpForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3.5 p-8 lg:p-12">
      <h2
        className={cn(
      ...
      <div className="gap-4 grid lg:grid-cols-2">
        ...
        <div>
          <Input
            ...
            onChange={(e) => handleSignUpFormChange("lastName", e.target.value)}
          />
        ...
        <div className="lg:col-span-2">
          ...
          {signUpFormError.email && (
            <p className="mt-1 text-red-500 text-xs">{signUpFormError.email}</p>
          )}
        </div>
        ...
        <div>
          <div className="relative">
            <Input
              ...
              onChange={(e) => handleSignUpFormChange("mobile", e.target.value)}
            />
        ...
        <div>
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="individual (NRI-NRO)">
                Individual (NRI-NRO)
              </SelectItem>
      ...
      <p className="flex gap-2 text-sm">
        ...
        >
          By continuing, I certify that I am 18 years of age or older, and agree
          to the{" "}
