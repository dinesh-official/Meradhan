...
export function splitAddressInto3BalancedLines(
  ...
  return {
    ...
    line2: lines[1],
    line3: lines[2],
    lengths: [lines[0].length, lines[1].length, lines[2].length],
    tokens,
  };
}

// const rawAddress = "W/O Pankaj Singh, Village Kalyanpur East, Post Office Kalyanpur, Near Panchayat Bhawan, Tehsil Sadar, Muzaffarpur, Bihar, 842001";
// const trimmedAddress = removeLastCommaChunks(rawAddress, 3);
// const addr = splitAddressInto3BalancedLines(trimmedAddress);
// const addr = splitAddressInto3BalancedLines(trimmedAddress);
