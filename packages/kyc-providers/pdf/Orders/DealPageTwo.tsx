...
Settlement No.: ${orderData?.metadata?.settlementNumber ?? "—"}`}
      ...
      <View style={tw(`mt-1 flex flex-col`)}>
        ...
        <Text style={tw(`text-[8px] leading-5`)}>b) Settlement Date and Time reflects the Date and Time of settlement as provided by the Stock Exchanges/ Clearing Corporation.</Text>
      </View>

      <Text style={tw(`text-[8px] mt-6 text-center font-bold`)}>The End</Text>
    </View>
  );
}
