 ...
 */
function CorporateKycPdfPage5Content() {
  ...
  return (
    <View style={[{ fontFamily: "Poppins" }, pad]}>
      ...
      <View style={tw("flex flex-row flex-wrap gap-x-6 gap-y-2 mt-2 items-end")}>
        <View style={tw("w-[42%]")}>
          <CheckBoxRow label="NCL" checked={false} />
          <InputField title="(Direct Code if any)" value=" " className="" />
        </View>
        <View style={tw("w-[42%]")}>
          <CheckBoxRow label="ICCL" checked={false} />
          <InputField title="(Direct Code if any)" value=" " className="" />
        </View>
      </View>
      ...
      <View style={tw("flex flex-row flex-wrap gap-x-6 gap-y-1 mt-2")}>
        <CheckBoxRow label="Aggressive" checked={false} />
        <CheckBoxRow label="Moderate" checked={false} />
        <CheckBoxRow label="Conservative" checked={false} />
      </View>
      ...
      <View style={tw("flex flex-row gap-2 mt-2 flex-wrap")}>
        ...
        <View style={tw("w-[34%]")}>
          <InputField title="Referrer / Applicant Code:" value=" " className="" />
        </View>
      </View>
      ...
      <View style={{ marginTop: 8 }}>
        ...
        <View style={tw("flex flex-row gap-2 mt-2 items-end flex-wrap")}>
          <View style={tw("w-[48%]")}>
            <InputField title="(Direct Code if any) SGL" value=" " className="" />
          </View>
        </View>
      </View>
