  ...
  return (
    <View style={tw(`w-[90%] px-4 mx-auto mt-4 text-xs`)}>
      ...
      <View style={tw(`w-[50%] mt-2 ml-5`)}>
        <TextFiled title="Name of nominee(s)" className="pr-24" value={nomineeName} />
      </View>
      ...
      <View style={tw(`flex flex-col gap-2 mt-3`)}>
        <View style={tw(`flex flex-row gap-3`)}>
          ...
          <View
            style={tw(`border-b border-gray-200 py-1 items-start w-[35%] justify-start`)}
          >
            <Text style={tw(`font-[600]`)}>{nomineeName}</Text>
          </View>
          <Text style={tw(`mt-1`)}>(nominee number</Text>
          <View
            style={tw(`border-b border-gray-200 py-1 items-center w-[4%] text-center justify-center`)}
          >
        ...
        <View style={tw(`flex flex-row gap-3 ml-5`)}>
          ...
          <View style={tw(`border-b border-gray-200 py-1 items-start w-[5%] justify-start`)}>
            <Text style={tw(`font-[600]`)}>100</Text>
          </View>
          <Text style={tw(`mt-1`)}>
            % of assets in the account / folio or Rs.
          </Text>
          <View style={tw(`border-b border-gray-200 py-1 items-start w-[24%] justify-start`)}>
      ...
      <View style={tw(`border-b border-t mt-8 flex flex-row border-gray-200`)}>
        <View style={tw(`w-[30%] border-r border-gray-200 p-2 font-[500] flex justify-center`)}>
          <Text style={tw(`text-center text-[7px]`)}>Name(s) of holder(s)</Text>
        </View>
        <View style={tw(`w-[23%] flex p-2 justify-center border-r border-gray-200 font-[500]`)}>
          <Text style={tw(`text-center text-[7px]`)}>Signature(s) of holder</Text>
        </View>
        <View style={tw(`w-[23%] flex p-2 border-r border-gray-200 justify-center font-[500]`)}>
          <Text style={tw(`text-center text-[7px]`)}>Witness Signature*</Text>
        </View>
        <View style={tw(`w-[24%] flex p-2 justify-center font-[500]`)}>
          <Text style={tw(`text-center text-[7px]`)}>Name of Witness & Address (wherever applicable)*</Text>
        </View>
      </View>
      ...
      {[fullName].map((holder, idx) => (
        <View key={idx} style={tw(`border-b flex flex-row border-gray-200`)}>
          <View style={tw(`w-[15%] border-r border-gray-200 p-2 flex justify-center`)}>
            <Text style={tw(`text-left text-[7px]`)}>Sole / First Holder (Mr./Ms.)</Text>
          </View>
          <View style={tw(`w-[15%] border-r border-gray-200 p-2 flex justify-center`)}>
            <Text style={tw(`text-center text-[7px]`)}>{holder}</Text>
          </View>
          <View style={tw(`w-[23%] flex p-2 justify-center border-r border-gray-200`)}>
            <Image src={signature} style={tw(`w-40 h-20 object-contain mx-auto`)} />
          </View>
          <View style={tw(`w-[23%] flex p-2 border-r border-gray-200 justify-center`)} />
