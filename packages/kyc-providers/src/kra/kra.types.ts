export type T_APP_PAN_INQ = {
  APP_RES_ROOT: {
    APP_PAN_INQ: {
      ...
      /** Present in some responses (e.g. registration acknowledgement / forwarded cases) */
      APP_ENTRYDT?: string;
      APP_IPV_FLAG: string;
      APP_KYC_MODE: string;
      APP_NAME: string;
      /** Present for some non-individual / registration flows */
      APP_PAN_DOB?: string;
      APP_PAN_NO: string;
      /** Present in registration responses */
      APP_POS_CODE?: string;
      APP_REQ_NO: string;
      APP_RES_NO: string;
      APP_STATUS: string;
...
/**
 * Non-Individual PAN Download response.
 *
 * Note: In real KRA payloads, some fields inside APP_ADDL_DATA may appear with
 * slight tag-name variations/typos (observed: APP_ADDLDTA_RESADD1, APP_ADDLDAA_RESPINCD).
 * This type supports both spellings.
 */
export type T_NON_INDIVIDUAL_PAN_DOWNLOAD = {
  APP_RES_ROOT: {
    APP_PAN_INQ: {
      APP_IOP_FLG: string;
      APP_POS_CODE: string;
      ...
      APP_ADDL_DATA?: Array<{
        ...
        /** Observed variant in response: APP_ADDLDTA_RESADD1 */
        APP_ADDLDATA_RESADD1?: string;
        APP_ADDLDTA_RESADD1?: string;
        APP_ADDLDATA_RESADD2?: string;
        APP_ADDLDATA_RESADD3?: string;
        APP_ADDLDATA_RESCITY?: string;
        /** Observed variant in response: APP_ADDLDAA_RESPINCD */
        APP_ADDLDATA_RESPINCD?: string;
        APP_ADDLDAA_RESPINCD?: string;
