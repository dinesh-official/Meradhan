...
export const searchStates = (query: string): { code: string; name: string }[] => {
...
export const ModificationReasonDescription: Record<ModificationReasonCode, string> = {
...
export const CancellationReasonDescription: Record<CancellationReasonCode, string> = {
