...
export interface ParticipantGroupAddResponse extends ParticipantGroupAddRequest {
...
export interface ParticipantLimitAddResponse extends ParticipantLimitAddRequest {
...
export type WithdrawNegotiationQuoteRequest = WithdrawNegotiationQuoteRequestItem[];
