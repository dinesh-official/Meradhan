...
export class ExpressServer implements IServer, IExpressRoute {
  ...
  start(cb?: () => void) {
    ...
    const allowedOrigins = [
      ...
      "https://preprod-crm.meradhan.co",
      "https://axs-fe.meradhan.co",
      "https://axs-be.meradhan.co",
      "https://axs-crm.meradhan.co",
      "https://sm4rf.meradhan.co",
      "https://sm4rb.meradhan.co",
      "https://sm4rc.meradhan.co",
      ...(isDevelopment
        ? [
          "http://localhost:3000",
          "http://localhost:3001",
