...
rfqMasterRouter.get("/api/crm/rfq/nse/find/:number", withCrmAuthMiddleware, (req, res) => controller.getRfqById(req, res));
...
rfqMasterRouter.post("/api/crm/rfq/nse/negotiations", withCrmAuthMiddleware, (req, res) => controller.getAllNegotiations(req, res));
rfqMasterRouter.post("/api/crm/rfq/nse/deal/propose", withCrmAuthMiddleware, (req, res) => controller.proposeDeal(req, res));
