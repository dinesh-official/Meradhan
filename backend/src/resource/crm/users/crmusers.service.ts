...
export class CrmUserService {
    ...
    async findManyUser(payload: z.infer<typeof appSchema.crm.user.findManyUserSchema>) {
    ...
    async createNewUser(payload: z.infer<typeof appSchema.crm.user.createCRMUserSchema>, createdBy: number,) {
    ...
    async updateUser(id: number, payload: z.infer<typeof appSchema.crm.user.updateUserSchema>) {
