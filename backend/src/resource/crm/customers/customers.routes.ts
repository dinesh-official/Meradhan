...
crmCustomersRoutes.delete("/api/crm/customer/:customerId", withCrmAuthMiddleware, (req, res) => controller.softDeleteCustomer(req, res));
crmCustomersRoutes.delete("/api/crm/customer/force/:customerId", withCrmAuthMiddleware, (req, res) => controller.deleteCustomer(req, res));
