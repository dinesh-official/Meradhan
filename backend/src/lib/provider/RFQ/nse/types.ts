...
export type UnregisteredParticipantFinalUpdateContactResponse = UnregisteredParticipantResponse;
 ...
 */
export type UpdateUnregisteredDpAccountStatusResponse = UnregisteredDpAccountResponse;
 ...
 * Same as response for /rest/v1/unreg/dpacc
 */
export type MarkDefaultUnregisteredDpAccountResponse = UnregisteredDpAccountResponse;
